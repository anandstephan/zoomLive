...
function websdkready() {
  ...
  var CLIENT_ID = "rhzrmC34Rk6XndTiET6qaQ";
   ...
   */
  var CLIENT_SECRET = "RA3myncleVvqp1NA3tM6LYalOo0xliN0";
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      if (!meetingConfig.mn || !meetingConfig.name) {
        alert("Meeting number or username is emptyw");
        return false;
      }
      ...
      console.log("meeting",meetingConfig)
